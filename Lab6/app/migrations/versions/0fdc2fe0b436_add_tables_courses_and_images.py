...
Revision ID: 0fdc2fe0b436
Revises: 7e27a888f81d
Create Date: 2022-05-25 16:56:56.842046
...
revision = '0fdc2fe0b436'
down_revision = '7e27a888f81d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('background_image_id', sa.String(100), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
